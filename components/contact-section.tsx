    ...
    >
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <div className="mt-12 flex flex-col items-center gap-3 sm:flex-row">
          ...
          <WhatsAppButton className="inline-flex w-full items-center justify-center gap-2.5 rounded-full bg-white px-8 py-4 text-[16px] font-semibold text-[#5437d9] transition-colors hover:bg-white/90 sm:w-auto">
