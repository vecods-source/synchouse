...
const reasons = [
  ...
  },
  {
    ...
    description: "Bank-level security protocols protect your data and your customers' trust.",
  },
  {
    icon: Users,
    title: "Expert Team",
    description: "Seasoned developers and designers with proven track records in enterprise software.",
  },
  {
    icon: Rocket,
...
export function WhyUsSection() {
  ...
  const handleConsultationSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: "Error",
          description: result.error || "Failed to schedule consultation. Please try again.",
          variant: "destructive",
        })
      }
    } catch (error) {
  ...
  return (
    <section id="why-us" className="border-b-4 border-foreground bg-secondary py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-16 text-center">
          <div className="mb-4 inline-block border-4 border-foreground bg-foreground px-4 py-2 pixel-corners">
            <span className="font-mono text-sm font-bold text-background">WHY CHOOSE US</span>
          </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {reasons.map((reason, index) => (
            <div key={reason.title} className="relative border-4 border-foreground bg-card p-8 pixel-corners">
              ...
              <h3 className="mb-3 font-mono text-2xl font-bold">{reason.title}</h3>
          ...
          <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleConsultationSubmit} className="space-y-6 mt-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="consultation-name" className="mb-2 block text-sm font-semibold">
                    Full Name *
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="consultation-phone" className="mb-2 block text-sm font-semibold">
                    Phone Number *
                  </Label>
                  <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="consultation-service" className="mb-2 block text-sm font-semibold">
                    Service Type *
                  </Label>
                  <Select
                    required
                    value={consultationData.serviceType}
                    onValueChange={(value) => setConsultationData({ ...consultationData, serviceType: value })}
                  >
                ...
                <div>
                  <Label htmlFor="consultation-role" className="mb-2 block text-sm font-semibold">
                    Your Role *
                  </Label>
                  <Input
                    ...
                    onChange={(e) => setConsultationData({ ...consultationData, role: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="consultation-date" className="mb-2 block text-sm font-semibold">
                    Preferred Date *
                  </Label>
                  <Input
                ...
                <div>
                  <Label htmlFor="consultation-time" className="mb-2 block text-sm font-semibold">
                    Preferred Time *
                  </Label>
                  <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="mb-3 block text-sm font-semibold">Inside Qatar? *</Label>
                  <RadioGroup
                    required
                    value={consultationData.insideQatar}
                    onValueChange={(value) => setConsultationData({ ...consultationData, insideQatar: value })}
                    className="flex flex-row gap-6"
                  >
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="yes" id="qatar-yes" />
                      <Label htmlFor="qatar-yes" className="cursor-pointer font-normal">
                        Yes
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="no" id="qatar-no" />
                      <Label htmlFor="qatar-no" className="cursor-pointer font-normal">
                        No
                      </Label>
                    </div>
                  </RadioGroup>
                ...
                <div>
                  <Label className="mb-3 block text-sm font-semibold">Preferred Language *</Label>
                  <RadioGroup
                    required
                    value={consultationData.preferredLanguage}
                    onValueChange={(value) => setConsultationData({ ...consultationData, preferredLanguage: value })}
                    className="flex flex-row gap-6"
                  >
                    <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => setConsultationData({ ...consultationData, contactMethod: value })}
                  className="flex flex-row gap-6"
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="call" id="consultation-call" />
                    <Label htmlFor="consultation-call" className="cursor-pointer font-normal">
                      Phone Call
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="whatsapp" id="consultation-whatsapp" />
                    <Label htmlFor="consultation-whatsapp" className="cursor-pointer font-normal">
                      WhatsApp
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                <Label htmlFor="consultation-note" className="mb-2 block text-sm font-semibold">
                ...
                <Textarea
                  ...
                  onChange={(e) => setConsultationData({ ...consultationData, note: e.target.value })}
